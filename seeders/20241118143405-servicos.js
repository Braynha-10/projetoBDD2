    ...
    await queryInterface.bulkInsert('servicos', [
      {
        ...
        id_servico: 1, // Referência ao serviço com ID 1 (Troca de Óleo e Filtro)
      ...
      },
      {
        ...
        id_servico: 2, // Referência ao serviço com ID 2 (Alinhamento e Balanceamento)
      ...
      },
      {
        ...
        id_servico: 3, // Referência ao serviço com ID 3 (Troca de Pastilhas de Freio)
